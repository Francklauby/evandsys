...
<!-- mod_evandsys : type password au lieu de text (sécurité affichage) -->
<input type="password" maxlength="255" placeholder="<?php echo $langs->trans("NewPassword"); ?>" <?php echo $disabled; ?> id="newpass1" name="newpass1" class="flat input-icon-user minwidth150" value="" tabindex="1" autofocus />
<!-- fin_mod_evandsys -->
</div>
</div>
<div class="trinputlogin">
...
<span class="fa fa-user"></span>
<!-- mod_evandsys : type password au lieu de text (sécurité affichage) -->
<input type="password" maxlength="255" placeholder="<?php echo $langs->trans("PasswordRetype"); ?>" <?php echo $disabled; ?> id="newpass2" name="newpass2" class="flat input-icon-user minwidth150" value="" tabindex="1" />
<!-- fin_mod_evandsys -->
</div>
</div>
